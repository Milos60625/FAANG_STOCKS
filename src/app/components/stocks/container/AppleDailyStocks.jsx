...
class AppleDailyStocks extends Component {
    constructor(props) {
        super(props);
    }
    componentDidMount() {
        this.props.getDailyStocksTimeSeries("AAPL");
    }
    render() {
...
export default connect(mapStateToProps, { getDailyStocksTimeSeries })(AppleDailyStocks);
