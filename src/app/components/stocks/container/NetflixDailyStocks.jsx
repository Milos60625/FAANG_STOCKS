...
class NetflixDailyStocks extends Component {
    constructor(props) {
        super(props);
    }
    componentDidMount() {
        this.props.getDailyStocksTimeSeries("NFLX");
    }
    render() {
...
export default connect(mapStateToProps, { getDailyStocksTimeSeries })(NetflixDailyStocks);
