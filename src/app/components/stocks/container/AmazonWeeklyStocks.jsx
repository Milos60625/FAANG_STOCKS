...
class AmazonWeeklyStocks extends Component {
    constructor(props) {
        super(props);
    }
    componentDidMount() {
        this.props.getWeeklyStocksTimeSeries("AMZN");
    }
    render() {
...
export default connect(mapStateToProps, { getWeeklyStocksTimeSeries })(AmazonWeeklyStocks);
